    ...
    <custom-modal ref="customModal" :title="modalTitle">
      ...
      <template v-slot:actions>
        <soft-button-vue :loading="loading" form="manger-form" type="submit">
          {{ editModeId ? "Save Contractor" : "Add Contractor" }}
        </soft-button-vue>
      </template>
    </custom-modal>
    ...
    async deletUser() {
      try {
        ...
        this.$notify({
          type: "warning",
          title: "Contractor",
          text: "Contractor deleted succesfuly",
        });
      } catch (err) {
        console.log(err);
        this.$notify({
      ...
      try {
        ...
        this.$notify({
          ...
          text: !this.selectedStatus
            ? "Contractor set active successfully"
            : "Contractor set Inactive successfully",
        });
    ...
    async addNewManger() {
      try {
        ...
        this.$notify({
          type: "success",
          title: "Contractor",
          text: "Contractor added or updated succesfuly",
        });
